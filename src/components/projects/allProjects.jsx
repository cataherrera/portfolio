	...
	return (
		<div className="all-projects-container">
				<div className="all-projects-project" >
					...
					<p>I worked The student worked in a team with Vitorrio Nurzia, the Systems and Optics chief, and astronomer Pascale Hibbon. The objective of this project was to create tools to be able to monitor the performance of the Very Large Telescope (VLT). Monitoring performance indicators of the telescope is a critical factor in achieving the goal of having the best possible instruments and technology for astronomic research. For this project, the objective was to focus on metrics most relevant for science operations.</p>
					<p>The project was performed through Jupyter notebook files called dashboards, where each one had an implemented interface to make the information easily accessible for astronomers and Technical Instrument Operators (TIOs). The dashboards implemented by the students where UT Preset Sequence, UT Preset Time Analysis, Focus Change Sequence, Focus Change Time Analysis, Pointing Model Accuracy and Image Analysis Convergence Speed.</p>
